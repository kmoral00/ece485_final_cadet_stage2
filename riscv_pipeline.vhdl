   ...
   component alu_control is
    ...
    component pipeline_registers 
        Port (
            ...
            id_ex_instr : inout STD_LOGIC_VECTOR(31 downto 0); --changed from out to inout
...
begin
    ...
    pipe_reg: pipeline_registers
        port map (
            ...
            -- <add other mem_wb registers> --NEED to ADD Branch and Jump
    ...
    --if_id_rs1 <= if_id_instr(19 downto 15); --5 bits
    --if_id_rs2 <= if_id_instr(24 downto 20); --5 bits
    --if_id_rd  <= if_id_instr(11 downto 7); --5 bits
